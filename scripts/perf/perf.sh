...
# # Fetching configuration values using the function
...
# tx_payload_size=$(get_config_value 'tx_payload_size')

# # Debug: Print the main node directory to verify
# echo "Main Node Directory: $main_node_dir"
